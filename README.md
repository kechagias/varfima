...
**Purpose**:<br>
&nbsp; Provide SAS code for synthesizing statioanry multivariate time series from  a given covariance structure and for fitting  <br>
&nbsp; bivariate vector autoregressive fractionally integrated time series with general phase. The SAS functions in the  <br> 
&nbsp; VARFIMAModules.sas file implement the methods of <a href="https://onlinelibrary.wiley.com/doi/abs/10.1111/jtsa.12504">Kechagias and Pipiras (2019)</a> <br> 
...
&nbsp;  3. Change the path of the macro variable <i>localDirectory</i> in the beginning of these files to the path of your local directory <br>
&nbsp;  &nbsp; &nbsp;  (or to the path of the SAS Server directory if you are using SAS On Demand for Academics).  <br>

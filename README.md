...
&nbsp;  3. Change the path of the macro variable <p style="background-color:color:MediumSeaGreen;"> localDirectory </p> in the beginning of these files to your local directory <br>

...
&nbsp;  &nbsp; &nbsp;  upload the files to the SAS server via SAS Studio. Check out this <a href="https://support.sas.com/ondemand/manuals/UploadingDataUsers.pdf">guide</a> for more details. <br>
